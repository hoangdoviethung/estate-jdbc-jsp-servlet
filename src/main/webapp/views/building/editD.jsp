						...
						<form class="form-horizontal" role="form" id="formEdit">
								...
								<div class="col-sm-3">
									<div class="fg-line">
										<select class="form-control" id="sel1">
											<option value="" disabled selected>-Chọn người quản
												lí-</option>
								...
								<div class="col-sm-9">
									<div class="fg-line">
										<input type="text" class="form-control input-sm"
											name="structure" value="${model.structure}" />
									</div>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="fg-line">
										<input type="text" class="form-control input-sm"
											name="costDescription" value="${model.costDescription}" />
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="fg-line">
										<input type="text" class="form-control input-sm"
											name="carCost" value="${model.carCost}" />
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="fg-line">
										<input type="text" class="form-control input-sm"
											name="motorbikeCost" value="${model.motorbikeCost}" />
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="fg-line">
										<input type="text" class="form-control input-sm"
											name="overtimeCost" value="${model.overtimeCost}" />
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="fg-line">
										<input type="text" class="form-control input-sm"
											name="deposit" value="${model.deposit}" />
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<div class="fg-line">
										<input type="text" class="form-control input-sm"
											name="payment" value="${model.payment}" />
									</div>
								</div>
							</div>
									...
									<div class="fg-line">
										<div class="checkbox">
											<c:forEach var="item" items="${buildingtypes}">
												<label> <input type="checkbox" value="${item.key}"
													name="buildingTypes"
													${fn:contains(model.type,item.key) ? 'checked':'' }><b>${item.value}</b>
												</label>
											</c:forEach>
										</div>
									</div>
